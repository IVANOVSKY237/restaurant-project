  ...
  return (
    <div className='flex justify-between items-center px-8 mt-5'>
        <div>
            ...
            <p className='text-[#f5f5f5] text-sm font-mediumbold tracking-wide'>Give your best services for customers😄</p>
        </div>
        <div>
            <h1 className='text-[#f5f5f5] text-3xl font-bold tracking-wide[300px]'>{formatTime(dateTime)}</h1>
